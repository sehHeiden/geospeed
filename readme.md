...
**Last updated**: 2025-11-24T13:10:51Z  
**Python**: 3.13.7  
...
| Dask-GeoPandas | ✅ | 7.1s | 872 MB | ~19% faster than GeoPandas |
| DuckDB | ✅ | 8.6s | 479 MB | Lowest memory usage |
| GeoPandas (county-wise) | ✅ | 6.8s | 599 MB |  |
